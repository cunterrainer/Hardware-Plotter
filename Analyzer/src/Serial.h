...
namespace Serial
{
    ...
    {
    private:
        static std::string ExtractDeviceName([[maybe_unused]]const std::string& str) noexcept { return std::string(); }
    public:
        static std::vector<Port> GetPorts() noexcept { return std::vector<Port>(); }
    };
}
#endif